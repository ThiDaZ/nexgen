...
public class brandManage extends javax.swing.JPanel {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(brandTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 136, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        try {
            ResultSet rs = MySQL.execute("SELECT * FROM `brand` WHERE `brand` ='" + brandTextField.getText() + "'");
            if (rs.next()) {
                ...
                if (brandTextField.getText().isEmpty()) {
                    ...
                    MySQL.execute("INSERT INTO `brand` (`brand`) VALUES ('" + brandTextField.getText() + "')");
                    JOptionPane.showMessageDialog(this, "Brand Added", "Succesfull", JOptionPane.PLAIN_MESSAGE);
                    reset();
                }
            }
        } catch (Exception e) {
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        ...
        if (selectedRow == -1) {
            ...
            if (brandName.isEmpty()) {
                brandTextField.putClientProperty("JComponent.outline", "error");
            } else {
                try {
